...
Doing some dumb next. Trying to learn how this glm() thing works, and if it is useful at all. Using PRBCS_data
...
```{r}
# Making timepoints
variable_time <- data.frame(time=seq(0, 40500, by=420), ArticleAbbr=rep("A",length(tmp)))
tmp <- predict(object = p, newdata = variable_time, type="response")
